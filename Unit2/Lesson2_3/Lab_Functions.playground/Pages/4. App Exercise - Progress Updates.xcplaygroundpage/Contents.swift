...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    let projectedTime = (goalTime / totalDistance) * (totalDistance - currentDistance) + currentTime
...
pacing(currentDistance: 3.0, totalDistance: 5.0, currentTime: 30.0, goalTime: 50.0)
pacing(currentDistance: 3.0, totalDistance: 5.0, currentTime: 40.0, goalTime: 50.0)
/*:
