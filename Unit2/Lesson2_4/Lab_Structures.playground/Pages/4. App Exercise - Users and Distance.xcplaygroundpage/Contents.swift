...
var bryan = User(name: "Bryan", age: 22, height: 68, weight: 150, activityLevel: 8)
print("User \(bryan.name) is \(bryan.age) years old, \(bryan.height) inches tall, weighs \(bryan.weight) lbs, and has an activity level of \(bryan.activityLevel).")
/*:
...
var shortRun = Distance(feet: 3280.84)
print(shortRun.feet)
