...
let favoriteBook = Book(title: "The Cat in the Hat", author: "Dr. Seuss", pages: 72, price: 9.99)
...
let laptop2 = Laptop(screenSize: 15, repairCost: 2, yearPurchased: 2020)
/*:
...
let heightInInches = Height(inches: 50)
print(heightInInches.heightInInches)
print(heightInInches.heightInCentimeters)
let heightInCentimeters = Height(centimeters: 40)
print(heightInCentimeters.heightInInches)
print(heightInCentimeters.heightInCentimeters)
